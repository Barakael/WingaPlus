...
<head>
<meta charset="UTF-8">
<title>Warranty – <?php echo e($warranty->phone_name); ?></title>
<style>
    body{
        margin:0;
        padding:0;
...
<div class="card">
    ...
    <div class="content">
        ...
        <div class="meta">
            ...
            <div class="meta-item"><strong>IMEI/Serial:</strong> <?php echo e($warrantyDetails['imei_number'] ?? 'N/A'); ?></div>
            <div class="meta-item"><strong>Phone Specs:</strong> <?php echo e($warrantyDetails['color'] ?? 'N/A'); ?> - <?php echo e($warrantyDetails['storage'] ?? 'N/A'); ?></div>
            <div class="meta-item"><strong>Purchase Date:</strong> <?php echo e($sale->created_at->format('M d, Y')); ?></div>
            <div class="meta-item"><strong>Warranty Period:</strong> <?php echo e($sale->warranty_months); ?> months</div>
            <div class="meta-item"><strong>Warranty Expires:</strong> <?php echo e($sale->warranty_end ? $sale->warranty_end->format('M d, Y') : 'N/A'); ?></div>
        </div>      
          <div class="terms">
...
<?php /**PATH /Users/christinakimario/Documents/baraka/WingaPlus/WingaPlus_api/resources/views/emails/warranty_filed.blade.php ENDPATH**/ ?>